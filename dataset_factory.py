...
def get_coco_dataloader(img_ids_file_path, imgs_root_dir, annotation_file_path, coco_obj, vocabulary, config_data, augment):
    ...
    dataset = CocoDataset(root=imgs_root_dir,
                          ...
                          ids=ann_ids,
                          vocab=vocabulary,
                          img_size=config_data['dataset']['img_size'], augment = augment)
